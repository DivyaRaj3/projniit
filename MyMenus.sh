...
;;                  
             ...
             case $ques2 in
                             ...
                             1) clear;
                                 hadoop jar /home/divya/Desktop/proj3jar.jar file:///home/divya/Documents/project/h1bs1 \proj3out26
                                 hadoop fs -cat /user/hduser/op5/p*
                                  ;;
                             2) clear;
                                 hadoop jar /home/divya/Desktop/proj4jar.jar  file:///home/divya/Documents/project/h1bs1 \proj4out8              
                                  ;; 
                             3) clear;
                                 hadoop jar /home/divya/Desktop/proj5jar.jar file:///home/divya/Documents/project/h1bs1 \proj5out15
                                  ;;
                             4) clear;
                                 hadoop jar /home/divya/Desktop/proj6jar.jar file:///home/divya/Documents/project/h1bs1 \proj6out21
                                      ;;
                             *) clear;
                                      echo "DEFAULT"
esac
...
;;
				...
				insert overwrite directory '/niit' select job_title, ROUND((count(*) * 100/3002048),2) as c1 from h1b where case_status = "CERTIFIED" or case_status= "CERTIFIED-WITHDRAWN" 					group by job_title order by c1 desc limit 10;
